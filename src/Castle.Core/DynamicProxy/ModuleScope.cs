...
namespace Castle.DynamicProxy
{
	...
	public class ModuleScope
	{
		...
		internal Type GetOrAddFromCache(CacheKey key, Func<CacheKey, Type> factory)
		{
		...
		private void AddCacheMappings(AssemblyBuilder builder)
		{
			...
			{
				if (builder.Equals(type.Value.Assembly))
				{
					mappings.Add(type.Key, type.Value.FullName);
				}
			}
